    ...
    return (
        <div className='w-full py-vh5'>
            <div className='w-full px-vw5 flex flex-col gap-vh5'>
                <section className='w-full flex flex-col gap-vh5 sm_:gap-vh3 items-center'>
                    <h1 className='font-bold text-3xl text-center  capitalize text-service_svg_bg'>Our Services</h1>
                    <p className='w-p80  text-center sm_:w-full ' >Paragraphs are the building blocks of papers. Many students define paragraphs in terms of length: a paragraph is a group of at least five sentences, a paragraph is half a page long, etc</p>
                </section>
                <section className='w-full flex justify-center items-center gap-vw5 sm_:flex-col'>
                    {
