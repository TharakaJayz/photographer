...
const Navbar = (props: Props) => {
    ...
    return (
        <div className='  w-full    bg-navcolor  py-vh2  '>
            <div className=' w-full h-full flex items-center justify-between   lg_:flex-col'>
                ...
                <section className={`flex items-center gap-vw3 text-white  transition-all duration-500 origin-top  lg_:w-full  lg_:flex-col   scale-y-0 h-0 lg_:opacity-0 lg_:gap-vh3 lg_:items-start ${navSecLogic &&(' lg_:pt-vh5 lg_:pb-vh2 lg_:scale-y-100 lg_:h-vh56   lg_:opacity-100 ')}`}>
                    ...
                    <button className='bg-transparent border border-white text-white font-semibold px-vw1 py-vh1 rounded  transition-all cursor-pointer hover:bg-primary hover:border-primary ml-vw5'   >Request a Quote</button>
                </section>
