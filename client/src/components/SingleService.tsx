...
const SingleService = (props: serviceType) => {
    return (
        <div key={props.keyIndex} className='w-p35 xl_:w-full border border-gray-200 rounded-2xl bg-primary_light1 flex items-center justify-center py-vh5 opacity-0  home_service_animation'>
